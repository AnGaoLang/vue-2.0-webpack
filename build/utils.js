'use strict'
// webpack配置需要用到的工具函数，主要用于生成css loader和style loader的一些方法
...
exports.assetsPath = function (_path) {
  ...
  return path.posix.join(assetsSubDirectory, _path) //path.posix 和 path.win32，前者跨平台，后者只是win上的path调用，path的一种兼容写法
}

// 为不同的css预处理器提供一个统一的生成方式，统一处理各种css类型的打包问题。
// 这个是为在vue文件中的style中使用的css类型，具体配置传参options
